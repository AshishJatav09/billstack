...
const messageTemplateSchema = new mongoose.Schema(
  {
    ...
    category: { type: String, enum: ["INVOICE_CREATED", "INVOICE_DUE_SOON", "DUE_TODAY", "PAYMENT_OVERDUE", "PAYMENT_REMINDER", "PAYMENT_RECEIVED", "QUOTATION", "CREDIT_NOTE", "SALES_RETURN", "CUSTOM"], default: "CUSTOM" },
...
messageTemplateSchema.index(
  { businessId: 1, category: 1, channel: 1, isDefault: 1 },
